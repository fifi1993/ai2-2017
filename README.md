...
print_two(a=4,1) - SyntaxError: non-keyword arg after keyword arg
...
print_two(b=4, 1) - SyntaxError: non-keyword arg after keyword arg
...
print_two(1, a=1) - TypeError: print_two() got multiple values for argument 'a'

print_two(4,1, b=1) - TypeError: print_two() got multiple values for argument 'b'
...
keyword_args(c=7,1) - SyntaxError: non-keyword arg after keyword arg
